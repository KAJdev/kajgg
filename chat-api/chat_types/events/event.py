...
Event = {"t": EventType.AUTHOR_UPDATED, "d": AuthorUpdated} | {"t": EventType.CHANNEL_CREATED, "d": ChannelCreated} | {"t": EventType.CHANNEL_UPDATED, "d": ChannelUpdated} | {"t": EventType.MESSAGE_CREATED, "d": MessageCreated} | {"t": EventType.MESSAGE_DELETED, "d": MessageDeleted} | {"t": EventType.MESSAGE_UPDATED, "d": MessageUpdated} | {"t": EventType.TYPING_STARTED, "d": TypingStarted}
